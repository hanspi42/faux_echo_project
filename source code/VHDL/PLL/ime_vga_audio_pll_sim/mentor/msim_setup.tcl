...
# ----------------------------------------
# If ime_vga_audio_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2020.12.24.12:42:52
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ime_vga_audio_pll"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "E:/tools/quartusprime18/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ime_vga_audio_pll.vho"
}

-- -------------------------------------------------------------
-- 
-- File Name: E:\Users\Donut\Dokumente\FHNW\7. Semester\pro7E\Matlab\2021a\hdl_coder\Der_Faux_FPGA_ovs150_WL46\Difference1.vhd
...
-- 
-- Module: Difference1
-- Source Path: Der_Faux_FPGA_ovs150_WL46/Der_Faux_FPGA/Difference1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Diff_out1 <= "0111111111111111111111111111111111111111111111" WHEN (Diff_sub_temp(46) = '0') AND (Diff_sub_temp(45 DOWNTO 39) /= "0000000") ELSE
      "1000000000000000000000000000000000000000000000" WHEN (Diff_sub_temp(46) = '1') AND (Diff_sub_temp(45 DOWNTO 39) /= "1111111") ELSE
      Diff_sub_temp(39 DOWNTO 0) & '0' & '0' & '0' & '0' & '0' & '0';

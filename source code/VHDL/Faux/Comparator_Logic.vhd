-- -------------------------------------------------------------
-- 
-- File Name: E:\Users\Donut\Dokumente\FHNW\7. Semester\pro7E\Matlab\2021a\hdl_coder\Der_Faux_FPGA_ovs150_WL46\Comparator_Logic.vhd
...
-- Source Path: Der_Faux_FPGA_ovs150_WL46/Der_Faux_FPGA/Comparator Logic
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Comparator_Logic IS
  ...
  -- Signals
  SIGNAL in_noninverted_signed            : signed(45 DOWNTO 0);  -- sfix46_En41
  SIGNAL in_inverted_signed               : signed(45 DOWNTO 0);  -- sfix46_En41
  SIGNAL Relational_Operator1_relop1      : std_logic;
  SIGNAL switch_compare_1                 : std_logic;
  SIGNAL Constant5_out1                   : signed(45 DOWNTO 0);  -- sfix46_En55
  SIGNAL Constant5_out1_dtc               : signed(45 DOWNTO 0);  -- sfix46_En53
  ...
  SIGNAL Constant5_out1_dtc_1             : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Relational_Operator_relop1       : std_logic;
  SIGNAL switch_compare_1_2               : std_logic;
  SIGNAL Constant1_out1_dtc               : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Switch1_out1                     : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Constant1_out1_dtc_1             : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Switch6_out1                     : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Switch_out1                      : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Aliasing_FF1_bypass_delay        : signed(45 DOWNTO 0);  -- sfix46
  SIGNAL Aliasing_FF1_reg                 : signed(45 DOWNTO 0);  -- sfix46
  SIGNAL Aliasing_FF1_out1                : signed(45 DOWNTO 0);  -- sfix46_En53
  ...
  SIGNAL Constant12_out1_dtc              : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Constant10_out1                  : unsigned(45 DOWNTO 0);  -- ufix46_En56
  SIGNAL Constant10_out1_dtc              : signed(45 DOWNTO 0);  -- sfix46_En53
  SIGNAL Dem_logic                        : signed(45 DOWNTO 0);  -- sfix46_En53
...
BEGIN
  ...
  Constant5_out1_dtc <= resize(Constant5_out1(45 DOWNTO 2), 46);
  ...
  Constant5_out1_dtc_1 <= resize(Constant5_out1(45 DOWNTO 2), 46);
  ...
  Constant1_out1_dtc <= signed(resize(Constant1_out1(45 DOWNTO 3), 46));

  
  Switch1_out1 <= Constant5_out1_dtc WHEN switch_compare_1 = '0' ELSE
      Constant1_out1_dtc;

  Constant1_out1_dtc_1 <= signed(resize(Constant1_out1(45 DOWNTO 3), 46));
  ...
  Aliasing_FF1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '0' THEN
      Aliasing_FF1_bypass_delay <= to_signed(0, 46);
      Aliasing_FF1_reg <= to_signed(0, 46);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' AND clk_div = '1' THEN
        Aliasing_FF1_bypass_delay <= Aliasing_FF1_reg;
        Aliasing_FF1_reg <= Switch_out1;
      END IF;
    END IF;
  END PROCESS Aliasing_FF1_process;

  
  Aliasing_FF1_out1 <= Aliasing_FF1_reg WHEN clk_div = '1' ELSE
      Aliasing_FF1_bypass_delay;
  ...
  Constant12_out1_dtc <= resize(Constant12_out1(45 DOWNTO 2), 46);

  Constant10_out1 <= unsigned'("1111101110101000100000100110101010101000111011");

  Constant10_out1_dtc <= signed(resize(Constant10_out1(45 DOWNTO 3), 46));
